COSC 2671/COSC 3047 — Assignment 2 | Group 8
Twitter/X Exodus to Mastodon: Analysing the Impact
Team Members:
...
1. 01_s4140718_PG_Group_08.ipynb
...
3. 02_s4140718_PG_Group_08.ipynb
...
5. 03_s4140718_PG_Group_08.ipynb
...
================================================================
RUNNING THE ANALYSIS (Skipping Notebook 1)
================================================================
If you want to skip the data extraction step (which will around 10 minutes), please refer to the steps below:

The full cleaned dataset is included in the mastodon_data_clean/ (SAMPLE FOLDER)
...
- Sample data folder is mastodon_data_clean